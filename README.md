...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/blitz-new-issue-v2.0.0-beta.27
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/blitz-new-issue-v2.0.0-beta.27_test
```
...
```
blitz-new-issue-v2.0.0-beta.27
├── src/
│   ├── api/
│   ├── auth/
│   │   ├── components/
